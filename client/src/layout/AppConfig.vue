            ...
            <section class="py-4 border-bottom-1 surface-border">
                ...
                <div class="flex align-items-center justify-content-between gap-3 mb-3">
                    <button
                        ...
                        <span
                            ...
                            style="border-radius: 30px; background: linear-gradient(180deg, #4dac9c 0%, rgba(77, 172, 156, 0.5) 100%)"
                            />
                    </button>
                    <button
                        :class="[
                        ...
                        <span
                            class="block h-1rem w-full"
                            style="border-radius: 30px; background: linear-gradient(180deg, #06b6d4 0%, rgba(6, 182, 212, 0.5) 100%)"
                            />
                    </button>
                    <button
                        :class="[
                        ...
                        <span
                            class="block h-1rem w-full"
                            style="border-radius: 30px; background: linear-gradient(180deg, #4378e6 0%, rgba(67, 120, 230, 0.5) 100%)"
                            />
                    </button>
                    <button
                        :class="[
                        ...
                        <span
                            class="block h-1rem w-full"
                            style="border-radius: 30px; background: linear-gradient(180deg, #585fe0 0%, rgba(88, 95, 224, 0.5) 100%)"
                            />
                    </button>
                </div>
                <div class="flex align-items-center justify-content-between gap-3 mb-3">
                    <button
                        ...
                        <span
                            class="block h-1rem w-full"
                            style="border-radius: 30px; background: linear-gradient(180deg, #7758e4 0%, rgba(119, 88, 228, 0.5) 100%)"
                            />
                    </button>
                    <button
                        :class="[
                        ...
                        <span
                            class="block h-1rem w-full"
                            style="border-radius: 30px; background: linear-gradient(180deg, #f59e0b 0%, rgba(245, 158, 11, 0.5) 100%)"
                            />
                    </button>
                    <button
                        :class="[
                        ...
                        <span
                            class="block h-1rem w-full"
                            style="border-radius: 30px; background: linear-gradient(180deg, #14b8a6 0%, rgba(20, 184, 166, 0.5) 100%)"
                            />
                    </button>
                    <button
                        :class="[
                        ...
                        <span
                            class="block h-1rem w-full"
                            style="border-radius: 30px; background: linear-gradient(180deg, #ec4899 0%, rgba(236, 72, 153, 0.5) 100%)"
                            />
                    </button>
                </div>
                <div class="flex align-items-center justify-content-between gap-3">
                    <button
                        ...
                        <span
                            class="block h-1rem w-full"
                            style="border-radius: 30px; background: linear-gradient(180deg, #0f172a 0%, rgba(0, 0, 0, 0.5) 100%)"
                            />
                    </button>
                    <button
                        :class="[
                        ...
                        <span
                            class="block h-1rem w-full"
                            style="border-radius: 30px; background: linear-gradient(180deg, #84cc16 0%, rgb(132, 204, 22, 0.5) 100%)"
                            />
                    </button>
                    <span class="w-3" />
                    <span class="w-3" />
            ...
            <section class="py-4 border-bottom-1 surface-border">
                ...
                <div class="flex align-items-center justify-content-between gap-3">
                    <button
                        ...
                        <span
                            class="block h-1rem w-full"
                            style="border-radius: 30px; background: linear-gradient(180deg, #0565f2 0%, rgba(5, 101, 242, 0.5) 100%)"
                            />
                    </button>
                    <button
                        :class="[
                        ...
                        <span
                            class="block h-1rem w-full"
                            style="border-radius: 30px; background: linear-gradient(180deg, #702f92 0%, rgba(112, 47, 146, 0.5) 100%)"
                            />
                    </button>
                    <div class="w-3" />
                    <div class="w-3" />
